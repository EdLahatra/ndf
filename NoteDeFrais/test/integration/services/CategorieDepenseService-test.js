...
import CategorieDepenseService from '../../../app/services/CategorieDepenseService';
...
describe('CategorieDepenseService', () => {
  ...
  let service = new CategorieDepenseService();
  ...
  it('should find and merge', (done) => {
    const id = '376a84e6-bcab-45f6-8a86-9a088f36dfcf';
