...
export default class ListEdit extends Component {
  ...
  _renderSelectedIcon(isSelected) {
    if (isSelected) {
      return (
        <View animation="jello" style={[Style.imageListPreview, Colors.greyDarker.background()]}>
          <MaterialIcons
            name="check"
            size={IconSize.small}
    ...
    if (this.state.dataSource) {
      ...
      const addIcon = this.shouldAdd() ?
        (<TouchableOpacity
          ...
          style={Style.buttonActionContainer}
        >
      ...
      return (
        <View style={Style.containerWithNavBar}>
          <ScrollView
            ...
            style={{ backgroundColor: Colors.greyLighter.code }}
          >
            {content}
          </ScrollView>
          {addIcon}
